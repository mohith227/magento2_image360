...
define([
    ...
    /**
     * Image360 gallery widget
     */
    $.widget('imagetoolbox.image360Gallery', $.mage.productGallery, {
        options: {
            imageSelector: '[data-role=image360image]',
    ...
    return $.imagetoolbox.image360Gallery;
});
