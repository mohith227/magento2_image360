...
define([
    ...
    $.widget('mage.image360MediaUploader', {
        ...
        _create: function () {
            var self = this,
                progressTmpl = mageTemplate('[data-template="image360-uploader"]');
            ...
            this.element.find('input[type=file]').fileupload({
                ...
                dropZone: '[data-tab-panel=image360-images]',
    ...
    return $.mage.image360MediaUploader;
});
